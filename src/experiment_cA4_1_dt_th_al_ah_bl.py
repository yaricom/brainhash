...
# -*- coding: utf-8 -*-
"""
The experiment with 10 Hz/5Hz, wisp, attention, 70, cA 4, delta, theta, alpha low, alpha high, beta low, batch size = 1 and 
balanced data set
...
experiment_name = 'cA_4_1_dt-th-a_l-a_h-b_l' # will be used as parent dir for analyzer results
