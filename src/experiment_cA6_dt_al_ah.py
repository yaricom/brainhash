...
# -*- coding: utf-8 -*-
"""
The experiment with 10 Hz/5Hz, wisp, attention, 70, cA 6, delta, alpha low, alpha high, batch size = 5 and 
balanced data set
...
experiment_name = 'cA_6_dt-a_l-a_h' # will be used as parent dir for analyzer results
