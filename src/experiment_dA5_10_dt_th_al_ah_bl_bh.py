...
# -*- coding: utf-8 -*-
"""
The experiment with 10 Hz/5Hz, wisp, attention, 70, dA 5, delta, theta, alpha low, alpha high, beta low, beta high, batch size = 10 and 
balanced data set. This is signal/noise classification experiment
...
experiment_name = 'dA_%d_%d_dt-th-a_l-a_h-b_l-b_h' % (n_hidden, batch_size) # will be used as parent dir for analyzer results
...
analyzer_config['corruption_level'] = 0.1
