...
# -*- coding: utf-8 -*-
"""
The experiment with 10 Hz/5Hz, wisp, attention, 70, cA 4, delta, theta, alpha low, alpha high, batch size = 5 and 
balanced data set
...
experiment_name = 'cA_4_dt-th-a_l-a_h' # will be used as parent dir for analyzer results
