...
# -*- coding: utf-8 -*-
"""
The experiment with 10 Hz/5Hz, wisp, attention, 70, cA 3, delta, alpha high, batch size = 5 and 
...
experiment_name = 'cA_%d_%d_dt-a_h_multiclass_signal_noise_%d' % (n_hidden, batch_size, max_cls_samples) # will be used as parent dir for analyzer results
...
analyzer_config['bands']            = 'delta,alpha_h'
